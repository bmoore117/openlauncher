...
public class InfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        content.setText(Html.fromHtml("<h1>SkyWall Additional Features</h1><p>SkyWall blocks a few things that aren't visible from the normal whitelisting pages. Specifically, it blocks areas in the Settings app that might allow you to circumvent or disable SkyWall. It only does this while delay is above zero; when delay is zero nothing is blocked. Specifically, SkyWall blocks:</p><ul><li>&nbsp;Clearing the SkyWall app cache & storage</li><li>&nbsp;Google Assistant explicit search result settings</li><li>&nbsp;Device Admin App settings</li><li>&nbsp;Default home app settings</li><li>&nbsp;SkyWall Accessibility service settings</li><li>&nbsp;Enablement of sideloading apps</li><li>&nbsp;Developer options</li><li>&nbsp;Disablement of the SkyWall Firefox browser add-on, if installed in Firefox</li></ul><p>All other actions in Settings are allowed, and other apps are allowed as whitelisted. If you attempt to access any of the aforementioned activities or settings, SkyWall will block them by simply swiping back virtually on the screen, to take you to the previous screen.</p>", 0));
        return view;
    }
